...
class BusflightView extends GetView<BusflightController> {
  ...
  Widget build(BuildContext context) {
    ...
    final String? showType = args?['type']; // 'bus' or 'flight'
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          showType == 'bus'
              ? 'bus_service'.tr
              : (showType == 'flight' ? 'bus_flight_booking'.tr : 'bus_and_flight'.tr),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // About Our Service Section (Only shown when not filtered)
              if (showType == null) ...[
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: Column(
