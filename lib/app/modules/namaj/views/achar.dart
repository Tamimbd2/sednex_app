      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoCard(
              items: [
                _buildInfoRow('time_label'.tr, 'যোহরের ওয়াক্ত শেষ হওয়া থেকে সূর্য অস্ত যাওয়ার আগ পর্যন্ত।'),
                _buildInfoRow('rakat_label'.tr, '৪ রাকাত সুন্নাত (গায়রে মুয়াক্কাদা) ও ৪ রাকাত ফরজ। মোট ৮ রাকাত।'),
                _buildInfoRow('niyat_label'.tr, 'আমি কেবলামুখী হয়ে আছরের (সুন্নাত/ফরজ) নামাজ আদায় করছি।'),
